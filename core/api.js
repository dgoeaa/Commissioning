...
import { unwrapActionResponse, liftEnvelope } from './contracts.js';
...
export async function invokeObsidianAction(action,payload={},options={}){ const a=ObsidianActionAliases[action]; if(!a) throw new Error('Unknown OBSIDIAN action '+action); return liftEnvelope(await invoke(a.endpoint,{operation:a.operation,...payload},options)); }
