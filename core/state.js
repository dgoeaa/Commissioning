...
const initial = { schemaVersion:AppConfig.stateSchemaVersion, profile:{name:'Registry',email:'dgsregistry@nitda.gov.ng',persona:'admin'}, settings:{theme:'light',density:'comfortable',maxBulkAssign:AppConfig.maxBulkAssign,endpoints:{},welcomeSeen:false,navCollapsed:null}, activities:[], tracking:[], correspondence:[], operations:[], registryFiles:[], fileMovements:[], registryMinutes:[], escalations:[], notifications:[], dispatches:[], correspondenceEmails:[], comments:[], approvals:[], users:bootstrapUsers, categories:[], departments:[], emails:[], audit:[], pending:[], adminRunbook:{}, runtime:{loading:false,lastLoad:null,lastError:null}, selectedId:null };
