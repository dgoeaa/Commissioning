...
export const RUNTIME_ENDPOINTS = Object.freeze([
  ...
  { key: 'AI_CHAT', transport: 'json', actions: ['aiChat'],
    note: 'AI chat' },
  { key: 'OTP_GENERATE', transport: 'json', actions: ['generate'],
    note: 'one-time passcode issue' },
  { key: 'OTP_VERIFY', transport: 'json', actions: ['verify'],
...
export const PORTAL_ENDPOINTS = Object.freeze([
  ...
  { key: 'WRITEBACK', transport: 'json', actions: ['respond', 'note', 'withdraw'],
    note: 'D13 / INT-007 — a verified citizen responds, adds a note, or withdraws; only withdraw changes status' },
]);
