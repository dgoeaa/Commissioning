...
export const PlatformProvisioning = Object.freeze({
  ...
  "admin-suite": {
    "purpose": "Administration console",
    "features": [
    ...
    "functions": [
      ...
      "inspectRequestShape",
      "validateComposedRequest",
      "recordCommissioningOutcome",
      "administerCapsuleRegistry",
  ...
  "endpoint-console": {
    "purpose": "Endpoint estate administration — all 25 contract keys and all 51 tenant workflows, reconciled against docs/reference/endpoint-register.json",
    "features": [
      "estate-findings",
      "contract-key-inventory",
      "flow-estate-inventory",
      "live-health-probe",
      "address-overrides",
      "redacted-export"
    ],
