...
export const EndpointContracts = Object.freeze({
  ...
  OTP_GENERATE: Object.freeze({ method:'POST', action:"generate", write:true, sourceKey:"OTP_GENERATE", url:EndpointUrls.OTP_GENERATE }),
  OTP_VERIFY: Object.freeze({ method:'POST', action:"verify", write:true, sourceKey:"OTP_VERIFY", url:EndpointUrls.OTP_VERIFY }),
