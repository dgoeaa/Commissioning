...
export const VisibleWorkspaces = Object.freeze([
  ...
  },
  {
    ...
    "owns": ["administrative-action-catalogue", "endpoint-estate-oversight", "flow-request-shapes", "live-endpoint-checks", "commissioning-register", "capsule-registry-administration", "platform-control", "evidence-export"],
    "handoffs": ["endpoint-console", "user-admin", "diagnostics", "settings", "operator-hud"]
  },
  {
    "id": "operator-hud",
    "route": "operator-hud",
...
export const HiddenTechnicalRoutes = Object.freeze({
  ...
  "endpoint-console": {
    "visibleThrough": "Administration",
    "reason": "The endpoint estate — every contract key on both surfaces and every workflow in the tenant, checked against the tenant register. It is reached from Administration and System Health rather than standing alone, because it is an infrastructure tool for systemAdmin, not a daily desk."
  }
});
