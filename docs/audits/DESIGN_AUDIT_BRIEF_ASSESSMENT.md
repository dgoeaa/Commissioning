...
> **This document carries no commands.** It is an assessment of an external design audit report. The steps for this estate live in
> [`PORTAL-TENANT-RUNBOOK.md`](../deployment/PORTAL-TENANT-RUNBOOK.md) and
...
**Report under assessment:** `docs/audits/design-audit-brief/ai-input.md`, the verified
...
> `docs/audits/design-audit-brief/integrity-manifest.json` and `- verification report.txt` assert that the
