...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-037` modules/single-assignment.js |
...
| Notifications issued | NOTIF-142 Records reloaded from the registry<br>NOTIF-143 The registry could not be reached — nothing was reloaded<br>NOTIF-144 Assignment draft saved<br>NOTIF-145 Assignment draft cleared<br>NOTIF-146 Assigned to — enter a valid email address. This is where the assignment notice goes.<br>NOTIF-147 Supporting assignee — enter a valid email address, or leave it blank. This is where the copy of the assignment goes.<br>NOTIF-148 Saved on this device — it will be sent to the registry when the connection returns |
| Downstream handoffs | — |
...
| --- | --- | --- | --- |
| SUBPROC-018 | Assign that record | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-044 | Route the task | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-059 | Raise a task from that email | Reusable governed write | An operator activates the control bound to this action. |
