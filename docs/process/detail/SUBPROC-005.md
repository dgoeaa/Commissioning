...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-039` modules/user-admin.js |
...
| Notifications issued | NOTIF-156 Email — enter a valid email address. This is how the person signs in and where their notices go.<br>NOTIF-157 User list reloaded from the registry<br>NOTIF-158 The registry could not be reached — the user list was not reloaded |
| Downstream handoffs | — |
...
| --- | --- | --- | --- |
| SUBPROC-035 | Create the user | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-036 | Update the user | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-037 | Disable the user | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-038 | assign-role | Reusable governed write | An operator activates the control bound to this action. |
