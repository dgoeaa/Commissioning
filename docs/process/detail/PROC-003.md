...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-010` modules/activities.js<br>`SRC-009` config/module-boundaries.config.js |
...
| --- | --- | --- | --- |
| SUBPROC-052 | Save the work state | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-057 | Mark the document | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-064 | Archive the activity | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-065 | Route the activity to SIWES | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-066 | Route the activity to NYSC | Reusable governed write | An operator activates the control bound to this action. |
