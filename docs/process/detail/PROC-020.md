...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-018` modules/correspondence-email.js<br>`SRC-009` config/module-boundaries.config.js |
...
| Notifications issued | NOTIF-047 Reloaded from the registry<br>NOTIF-048 The registry could not be reached — nothing was reloaded<br>NOTIF-049 Draft saved — it is in Drafts / Outbox and has not been sent<br>NOTIF-050 Letter sent — a copy is in the sent register<br>NOTIF-051 It could not be sent just now — it stays in the outbox and goes out when the connection is back<br>NOTIF-052 Draft duplicated<br>NOTIF-053 Archived — it is out of the outbox and was not sent |
| Downstream handoffs | — |
...
| --- | --- | --- | --- |
| SUBPROC-030 | Save the letter draft | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-031 | Send the letter | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-032 | Duplicate the letter draft | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-033 | Archive the letter | Reusable governed write | An operator activates the control bound to this action. |
