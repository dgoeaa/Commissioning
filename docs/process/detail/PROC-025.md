...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-020` modules/diagnostics.js<br>`SRC-009` config/module-boundaries.config.js |
...
| Notifications issued | NOTIF-067 Receipt ledger cleared |
| Downstream handoffs | — |
...
| --- | --- | --- | --- |
| SUBPROC-029 | Run the system checks | Reusable governed write | An operator activates the control bound to this action. |
