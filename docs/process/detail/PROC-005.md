...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-030` modules/orchestrator.js<br>`SRC-009` config/module-boundaries.config.js |
...
| Notifications issued | NOTIF-107 There is nothing in this list to export<br>NOTIF-108 Tasks refreshed from the registry<br>NOTIF-109 The registry could not be reached — nothing was refreshed<br>NOTIF-110 Task marked completed<br>NOTIF-111 A reminder date is required<br>NOTIF-112 Reminder saved on this device — it will reach the registry when the connection returns |
...
| --- | --- | --- | --- |
| SUBPROC-022 | Start work on that task | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-023 | Mark that work complete | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-053 | Set the reminder | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-058 | Update the task | Reusable governed write | An operator activates the control bound to this action. |
