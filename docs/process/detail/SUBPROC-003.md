...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-035` modules/scan-intake.js |
...
| Notifications issued | NOTIF-134 Deposited and recorded locally; synchronization queued<br>NOTIF-135 Nothing was deposited — the tray shows why |
| Downstream handoffs | — |
...
| --- | --- | --- | --- |
| SUBPROC-016 | Lodge the scanned document | Reusable governed write | An operator activates the control bound to this action. |
