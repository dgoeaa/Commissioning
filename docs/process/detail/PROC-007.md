...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-032` modules/registry.js<br>`SRC-009` config/module-boundaries.config.js |
...
| Notifications issued | NOTIF-119 Registry files reloaded<br>NOTIF-120 The registry could not be reached — nothing was reloaded<br>NOTIF-121 Official file registered<br>NOTIF-122 Recorded locally; synchronization queued<br>NOTIF-123 Minute recorded and file routed<br>NOTIF-124 Receipt and custody recorded<br>NOTIF-125 Handed to Archive Evidence<br>NOTIF-126 File closed |
...
| SUBPROC-047 | Register the file | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-048 | Route the file | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-049 | Record receipt of the file | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-050 | Close the file | Reusable governed write | An operator activates the control bound to this action. |
