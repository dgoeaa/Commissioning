...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-012` modules/approvals.js<br>`SRC-009` config/module-boundaries.config.js |
...
| Notifications issued | NOTIF-026 Approval request submitted<br>NOTIF-027 A reason is required to reject |
| Downstream handoffs | — |
...
| --- | --- | --- | --- |
| SUBPROC-024 | Record the approval | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-039 | Raise the approval request | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-040 | Record the rejection | Reusable governed write | An operator activates the control bound to this action. |
