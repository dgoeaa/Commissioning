...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-028` modules/meetings.js<br>`SRC-009` config/module-boundaries.config.js |
...
| Notifications issued | NOTIF-100 Meetings reloaded from the registry<br>NOTIF-101 The registry could not be reached — nothing was reloaded<br>NOTIF-102 Saved locally; synchronization queued<br>NOTIF-103 Meeting request logged<br>NOTIF-104 Recorded locally; synchronization queued<br>NOTIF-105 Created locally; synchronization queued |
| Downstream handoffs | — |
...
| --- | --- | --- | --- |
| SUBPROC-011 | Request the meeting | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-012 | Record the decision on the meeting | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-013 | Turn the meeting actions into tasks | Reusable governed write | An operator activates the control bound to this action. |
