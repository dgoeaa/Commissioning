...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-014` modules/assistant.js<br>`SRC-009` config/module-boundaries.config.js |
...
| Notifications issued | NOTIF-030 Write what you need help with first<br>NOTIF-031 Support request sent<br>NOTIF-032 Your support request could not be sent — try again in a moment<br>NOTIF-033 Answer received<br>NOTIF-034 The assistant could not answer |
| Downstream handoffs | — |
