...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-031` modules/projects.js<br>`SRC-009` config/module-boundaries.config.js |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CTRL-043 | Confirmation control | Operator confirmation — Add this project to the register | The operator is shown what is about to happen and must confirm before the write is attempted. | The operator activates the control this dialog guards. | Confirmation is given. | The governed write proceeds. | Declining returns to the workspace with nothing written. | Not evidenced beyond the decline path. | Confirmed |
| CTRL-044 | Confirmation control | Operator confirmation — Save these changes to the project | The operator is shown what is about to happen and must confirm before the write is attempted. | The operator activates the control this dialog guards. | Confirmation is given. | The governed write proceeds. | Declining returns to the workspace with nothing written. | Not evidenced beyond the decline path. | Confirmed |
...
| Notifications issued | NOTIF-113 Projects reloaded from the registry<br>NOTIF-114 The registry could not be reached — nothing was reloaded<br>NOTIF-115 Saved locally; synchronization queued<br>NOTIF-116 Project added<br>NOTIF-117 Updated locally; synchronization queued<br>NOTIF-118 Project updated |
| Downstream handoffs | — |
...
| --- | --- | --- | --- |
| SUBPROC-014 | Create the project | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-015 | Update the project | Reusable governed write | An operator activates the control bound to this action. |
