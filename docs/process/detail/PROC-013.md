...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-015` modules/briefs.js<br>`SRC-009` config/module-boundaries.config.js |
...
| Notifications issued | NOTIF-035 Briefs reloaded from the registry<br>NOTIF-036 The registry could not be reached — nothing was reloaded<br>NOTIF-037 Saved locally; synchronization queued<br>NOTIF-038 Brief saved as a draft<br>NOTIF-039 Recorded locally; synchronization queued |
| Downstream handoffs | — |
...
| --- | --- | --- | --- |
| SUBPROC-008 | Create the brief | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-009 | Submit the brief | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-010 | Record the decision on the brief | Reusable governed write | An operator activates the control bound to this action. |
