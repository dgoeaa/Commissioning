...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-017` modules/comments.js<br>`SRC-009` config/module-boundaries.config.js |
...
| Notifications issued | NOTIF-044 Comments reloaded from the registry<br>NOTIF-045 The registry could not be reached — nothing was reloaded<br>NOTIF-046 Comment posted |
| Downstream handoffs | — |
...
| --- | --- | --- | --- |
| SUBPROC-045 | Add the comment | Reusable governed write | An operator activates the control bound to this action. |
