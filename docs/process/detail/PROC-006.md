...
| Sources | `SRC-042` config/workflow-clarity.config.js<br>`SRC-008` modules/acknowledgment.js<br>`SRC-009` config/module-boundaries.config.js |
...
| --- | --- | --- | --- |
| SUBPROC-020 | Record the acknowledgment | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-021 | Send the acknowledgments still waiting | Reusable governed write | An operator activates the control bound to this action. |
| SUBPROC-046 | Send the reminder | Reusable governed write | An operator activates the control bound to this action. |
